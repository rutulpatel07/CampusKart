 ...
 * be verified on a real device. It is no longer the app's launch screen - it is reachable from
 * the Day 2 mockup gallery - and it disappears with the rest of the scaffolding once the real
 * screens land.
 */
@Composable
fun SetupStatusScreen(modifier: Modifier = Modifier) {
